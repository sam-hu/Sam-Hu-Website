...
function PlayTodayButton({ style, backTo }: { style?: React.CSSProperties, backTo?: string }) {
  ...
  return (
    <Button
      ...
      style={{
        height: '72px', fontSize: '16px', display: 'grid', gridTemplateColumns: '1fr auto 1fr', alignItems: 'center', justifyContent: 'center', padding: '0 24px', ...style,
      }}
    >
