...
import { colorsByDifficulty } from "./ConnectionsPlay";
...
const HowToPlay = ({ open, onClose }: { open: boolean, onClose: () => void }) => {
    return <Modal open={open} onCancel={onClose} onOk={onClose} cancelButtonProps={{ style: { display: 'none' } }}>
        ...
        <small>
            All credit goes to the New York Times for originally creating this game. This is just a tribute.
        </small>
    </Modal>
}
